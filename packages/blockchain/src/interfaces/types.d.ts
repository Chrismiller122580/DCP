import { Chain, CreateInvoiceInput } from '@dcp/core';
export interface PaymentProvider {
     ...
     */
    subscribeToPayments(address: string, onPayment: (result: PaymentVerificationResult) => void | Promise<void>): Promise<() => void>;
    /**
